...
extension UIColor {
    struct PrimaryColors {
        struct Background {
            static let background: UIColor = Color(lightMode: UIColor(hex: "F6F6F6") ?? white,
                                                   darkMode: UIColor(hex: "26282B") ?? .white).currentColor
        }
        struct Button {
    ...
    struct Catalog {
        ...
        struct Yellow {
            ...
            static let categoryBackground: UIColor = Color(lightMode: UIColor(hex: "FAC252") ?? .white,
                                                           darkMode: UIColor(hex: "D0A145") ?? .white).currentColor
        ...
        struct Green {
            static let categoryBackground: UIColor = Color(lightMode: UIColor(hex: "ACD4AF") ?? .white,
                                                           darkMode: UIColor(hex: "68A36D") ?? .white).currentColor
            static let categoryText: UIColor = Color(lightMode: UIColor(hex: "1E4221") ?? .white).currentColor
        }

        struct Purple {
            static let categoryBackground: UIColor = Color(lightMode: UIColor(hex: "B6A8CD") ?? .white,
                                                           darkMode: UIColor(hex: "796C8F") ?? .white).currentColor
            static let categoryText: UIColor = Color(lightMode: UIColor(hex: "4A3965") ?? .white).currentColor
        }

        struct LightYellow {
            static let categoryBackground: UIColor = Color(lightMode: UIColor(hex: "EDE38A") ?? .white,
                                                           darkMode: UIColor(hex: "D6C954") ?? .white).currentColor
            static let categoryText: UIColor = Color(lightMode: UIColor(hex: "847B2C") ?? .white).currentColor
        }

        struct Cyan {
            static let categoryBackground: UIColor = Color(lightMode: UIColor(hex: "ABDDD7") ?? .white,
                                                           darkMode: UIColor(hex: "D0A145") ?? .white).currentColor
